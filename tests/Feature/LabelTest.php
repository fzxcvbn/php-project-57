...
class LabelTest extends TestCase
{
    ...
    public function testCreateScreenCanBeRendered(): void
    {
        ...
        $this->actingAs($user)->get(route('labels.create'))->assertOk();
    }
    ...
    public function testCanBeCreated(): void
    {
        ...
        $this->actingAs($user)->post(route('labels.store'), $this->formData)->assertRedirect(route('labels.index'));
    ...
    {
        $this->post(route('labels.store'), $this->formData)->assertForbidden();
    }
    ...
    public function testEditScreenCanBeRendered(): void
    {
        ...
        $this->actingAs($user)->get(route('labels.edit', $label))->assertOk();
    }
    ...
    public function testEditScreenCannotBeRenderedForGuest(): void
    {
        ...
        $this->get(route('labels.edit', $label))->assertForbidden();
    }
    ...
    public function testCanBeUpdated(): void
    {
        ...
        $this->actingAs($user)->patch(route('labels.update', $label), $this->formData)->assertRedirect(route('labels.index'));
    ...
    public function testCannotBeUpdatedForGuest(): void
    {
        ...
        $this->patch(route('labels.update', $label), $this->formData)->assertForbidden();
    }
    ...
    public function testCanBeDeleted(): void
    {
        ...
        $this->actingAs($user)->delete(route('labels.destroy', $label))->assertRedirect(route('labels.index'));

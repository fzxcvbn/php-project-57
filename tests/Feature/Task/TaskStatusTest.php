...
class TaskStatusTest extends TestCase
{
    ...
    public function testCreateTaskStatusScreenCanBeRendered(): void
    {
        ...
        $this->actingAs($user)->get(route('task_statuses.create'))->assertOk();
    }
    ...
    public function testTaskStatusCanBeCreated(): void
    {
        ...
        $this->actingAs($user)->post(route('task_statuses.store'), $taskStatus->toArray())->assertRedirect(route('task_statuses.index'));
    ...
    public function testTaskStatusCannotBeCreatedForGuest(): void
    {
        ...
        $this->post(route('task_statuses.store'), $taskStatus)->assertForbidden();
    }
    ...
    public function testEditTaskStatusScreenCanBeRendered(): void
    {
        ...
        $this->actingAs($user)->get(route('task_statuses.edit', $taskStatus))->assertOk();
    }
    ...
    public function testEditTaskStatusScreenCannotBeRenderedForGuest(): void
    {
        ...
        $this->get(route('task_statuses.edit', $taskStatus))->assertForbidden();
    }
    ...
    public function testTaskStatusCanBeUpdated(): void
    {
        ...
        $this->actingAs($user)->patch(route('task_statuses.update', $taskStatus), $data)->assertRedirect(route('task_statuses.index'));
    ...
    public function testTaskStatusCannotBeUpdatedForGuest(): void
    {
        ...
        $this->patch(route('task_statuses.update', $taskStatus), $data)->assertForbidden();
    }
    ...
    public function testTaskStatusCanBeDeleted(): void
    {
        ...
        $this->actingAs($user)->delete(route('task_statuses.destroy', $taskStatus))->assertRedirect(route('task_statuses.index'));
    ...
    public function testTaskStatusCannotBeDeletedForGuest(): void
    {
        ...
        $this->delete(route('task_statuses.destroy', $taskStatus))->assertForbidden();
    }
}
